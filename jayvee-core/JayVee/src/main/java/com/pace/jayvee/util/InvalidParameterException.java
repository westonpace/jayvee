...
/**
 * An invalid parameter exception is thrown by workers and systems whenever one
 * of their parameters is incorrect.  Common reasons are that the parameter is 
 * out of range or not compatible with other parameters or some other reason like that.
 */
