...
/**
 * This is the basic interface for a sink of data.  Items can be pushed into a sink
 * and when a source has run out of things to put into the sink the sink can be end()'ed.
 * 
